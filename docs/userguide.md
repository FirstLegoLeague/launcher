...
You must allow cookies to be saved, as the TMS uses them to save passwords (to avoid having to login to each module individually). Login will fail is cookies are blocked. Note: Cookies are not used by TMS for any other purpose.
